...
YUI.add('yui-preload', function(Y) {
...
}, '3.6.0' ,{use:['yui','oop','dom','event-custom','event','event-base-ie','pluginhost','node','intl','io-base','json','transition','selector-css3','dom-style-ie','querystring-stringify-simple']});
